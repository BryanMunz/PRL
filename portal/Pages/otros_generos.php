...
<head>
    ...
    <title>Library State - Educativo</title>
...
<body>
    ...
    <div class="lastest container mt-4 mt-sm-5">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="font-weight-bolder float-left">Todos los Libros</h2>
            </div>
            <div class="col-lg-6">
        ...
        <div class="posts row">
            <div class="col-lg-2 col-md-3 col-sm-4">
                <div class="card mb-3">
                    <a href="../Pages/details.php"><img src="../img/eloquent.jpg" class="card-img-top" alt=""></a>
                    <div class="over text-center">
                        ...
                        <a class="reading btn" href="../Pages/details.php">Empezar a leer el CAP. 1</a>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title"><a href="../Pages/details.php">Eloquent JavaScript</a></h5>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4">
                <div class="card mb-3">
                    <a href="../Pages/details.php"><img src="../img/cleancode.jpg" class="card-img-top" alt=""></a>
                    <div class="over text-center">
                        <div class="head text-left">
                            <h6>Codigo Limpio</h6>
                        </div>
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a href="../Pages/details.php">Codigo Limpio</a></h5>
                        <p class="card-text">CH. 1</p>
                        <p class="card-text"><small class="text-muted text-uppercase">Terminado!</small></p>
                    </div>
                </div>
